...
import com.dh.clinica.repository.impl.DomicilioRepositoryH2;
...
public class PacienteServiceTest {
    private static PacienteService pacienteService = new PacienteService(new PacienteRepositoryH2());
    private DomicilioService domicilioService = new DomicilioService(new DomicilioRepositoryH2());
