...
import com.dh.clinica.util.JDBCHelper;
...
public class PacienteRepositoryH2 implements GenericRepository<Paciente> {
    ...
    private DomicilioRepositoryH2 domicilioRepositoryH2 = new DomicilioRepositoryH2();
    ...
    public Paciente guardar(Paciente paciente) {
        ...
        try {
            ...
            Domicilio domicilio = domicilioRepositoryH2.guardar(paciente.getDomicilio());
            ...
            preparedStatement.setDate(4, JDBCHelper.utilDateToSqlDate(paciente.getFechaIngreso()));
    ...
    public Paciente buscar(Integer id) {
        ...
        try {
            ...
            while (result.next()) {
                ...
                Domicilio domicilio = domicilioRepositoryH2.buscar(idDomicilio);
    ...
    public Paciente actualizar(Paciente paciente) {
        ...
        try {
            ...
            Domicilio domicilio = domicilioRepositoryH2.actualizar(paciente.getDomicilio());
