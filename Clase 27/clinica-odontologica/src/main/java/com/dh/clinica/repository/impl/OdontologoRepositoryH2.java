package com.dh.clinica.REPOSITORIO.impl;
...
public class OdontologoRepositoryH2 implements GenericRepository<Odontologo> {

    final static Logger log = Logger.getLogger(OdontologoRepositoryH2.class);
    ...
    public List<Odontologo> buscarTodos() {
        ...
        try {
            ...
            //2 Crear una sentencia
            preparedStatement = connection.prepareStatement("SELECT id, nombre,apellido,matricula FROM odontologos");
